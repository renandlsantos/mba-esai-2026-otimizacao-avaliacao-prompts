...
OpenAI client direto, timeout de 300 s, 4096 tokens, concorrência 1, gerador spark/code e juiz spark/code. Reutilizar funções congeladas com globals privados, parser estrito e erros redigidos. Checkpoint atômico por exemplo; relatório completo apenas após 15 exemplos. Sem nova dependência.
